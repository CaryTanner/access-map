...
export default function ReportFilter() {
 ...
 const dispatchFilter = (event) =>{
  ...
  return (
    ...
    <Radio.Group tabIndex={0} size="small" onChange={dispatchFilter} defaultValue='Reported-layer Scheduled-layer Fixed-layer Unresolved-layer' buttonStyle="solid" ariaRole="radiogroup">
